...
void font_atlas::finish()
{
    ...
    if(sdf_spread > 0)
    {
        ...
        generate_sdf(sdf.data(), tex_pixels_alpha8.data(), tex_width, tex_height, sdf_spread);
                                                           ...
                                                           const font_wchar* glyph_ranges)
{
    const unsigned int buf_decompressed_size =
        stb_decompress_length((const uint8_t*)compressed_ttf_data);
                          ...
                          float u1, float v1, float advance_x)
{
    ...
    glyph.u1 = u1;
    glyph.v1 = v1;
    glyph.advance_x = advance_x + config_data->glyph_extra_spacing.x; // Bake spacing into AdvanceX
