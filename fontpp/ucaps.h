...
constexpr static const uint32_t caps_table[CAPS_LEN][2] = {
	{ 0x0061, 0x0041 },
	{ 0x0062, 0x0042 },
	{ 0x0063, 0x0043 },
	{ 0x0064, 0x0044 },
...
struct case_table
{
    ...
    constexpr case_table(const T (&ctable)[rows][cols], bool swap_data)
    {
...
inline uint32_t find_upper_indexed(uint32_t ch)
{
...
inline uint32_t find_lower_indexed(uint32_t ch)
{
